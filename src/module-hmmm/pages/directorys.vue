<template>
    ...
    <el-card>
      ...
      <div style="margin-bottom:20px;">
        <el-form style="width:60%;display: flex;height: 32px;line-height: 32px;" label-width="80px">
          <el-form-item size="small" label="目录名称"><el-input v-model="page.directoryName" size="small" style="width:200px;"></el-input></el-form-item>
  ...
  <el-button @click="getDirect" size="small" type="primary">搜索</el-button>
</el-form>
      </div>
      <el-alert
    :title="alertTitle"
